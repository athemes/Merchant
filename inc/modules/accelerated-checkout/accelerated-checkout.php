...
function merchant_add_buy_now_button() {
	...
	if ( ! Merchant_Modules::is_module_active( 'accelerated-checkout' ) ) {
		return;
	}
	...
	?>
		<button type="submit" name="merchant-buy-now" value="<?php echo esc_attr( $product->get_ID() ); ?>" class="single_add_to_cart_button button alt wp-element-button merchant_buy_now_button"><?php esc_html_e( 'Buy Now', 'merchant' ); ?></button>
	<?php 
