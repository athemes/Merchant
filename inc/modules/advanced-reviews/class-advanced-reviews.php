...
class Merchant_Advanced_Reviews extends Merchant_Add_Module {
	...
	public function get_module_custom_css() {
		...
		$css .= Merchant_Custom_CSS::get_variable_css( self::MODULE_ID, 'stars_background_color', '#757575', '.merchant-adv-reviews, .merchant-adv-reviews-modal', '--mrc-adv-reviews-stars-bg-color' );
		...
		// Button Color (hover).
		$css .= Merchant_Custom_CSS::get_variable_css( self::MODULE_ID, 'button_color_hover', '#FFF', '.merchant-adv-reviews, .merchant-adv-reviews-modal', '--mrc-adv-reviews-button-color-hover' );
		...
		$css .= Merchant_Custom_CSS::get_variable_css( self::MODULE_ID, 'modal_close_icon_color_hover', '#757575', '.merchant-adv-reviews-modal', '--mrc-adv-reviews-modal-close-icon-color-hover' );
