				...
				'offer-details' => array(
					...
					'fields'      => array(
						...
						array(
							...
							'desc'    => esc_html__( 'Include all products in the cart in the quantity calculation condition.',   'merchant' ),
							'default' => false,
						...
						array(
							...
							'desc'    => esc_html__( 'Include all products from the same category in the quantity calculation condition.', 'merchant' ),
							'default' => false,
							'condition'   => array( 'rules_to_display', '==', 'categories' ),
						),
						array(
