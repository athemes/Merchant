...
/**
 * Real Time Search Ajax Handler.
 * As the plugin is loaded thourgh the 'init' hook, we have to register the ajax handlers outside of that hook, otherwise it's too late.
 *
...
/**
 * Real Time Search Ajax Handler class.
 *
 */
class Merchant_Real_Time_Search_Ajax_Handler {
	...
	public function ajax_search_callback() {
		...
		if ( $qry->have_posts() ) :
			...
			while ( $qry->have_posts() ) :
				...
				$output .= $this->get_ajax_search_item( $args );
	 ...
	 * @return string
	 */
	public function get_ajax_search_item( $args ) {
...
new Merchant_Real_Time_Search_Ajax_Handler();
