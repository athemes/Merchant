...
<div class="<?php echo wp_kses( implode( ' ', $wrapper_classes ), array() ); ?>">
	<?php if ( ! empty( $title ) ) : ?>
		<strong style="color: <?php echo esc_attr( $title_color ); ?>" class="merchant-reasons-list-title"><?php echo esc_html( $title ); ?></strong>
	<?php endif; ?>
	...
	<?php foreach ( $items as $item ) :
        ...
        ?>
        <div class="merchant-reasons-list-item" style="margin-top: <?php echo esc_attr( $spacing . 'px' ); ?>">
