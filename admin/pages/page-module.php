				...
				<div class="merchant-module-page-header">
					...
					<div class="merchant-module-page-actions">
						...
						<div class="merchant-module-page-actions-inner">
							...
							<a href="<?php echo esc_url( add_query_arg( array( 'preview' => 'true', 'module' => $module ), $module_info['preview_url'] ) ); ?>" target="_blank" class="merchant-module-page-button merchant-module-preview merchant-module-page-button-action-preview">
