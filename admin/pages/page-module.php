                        ...
                        <div class="merchant-module-page-actions">
                            ...
                            <div class="merchant-module-page-actions-inner">
                                ...
                                <div class="merchant-module-page-actions-links">
                                    ...
                                    <a href="<?php echo esc_url( add_query_arg( array( 'preview' => 'true', 'module' => $merchant_module ), $merchant_module_info['preview_url'] ) ); ?>"
                                       class="merchant-module-page-link merchant-module-page-link-preview" target="_blank">
                                        <span><?php echo esc_html__( 'View on site', 'merchant' ); ?></span>
