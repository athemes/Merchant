...
<style>
    ...
    .merchant-dashboard-alert p {
        margin: 0
    }

    .merchant-dashboard-alert.merchant-dashboard-alert-with-icon {
        position: relative;
        padding-left: 50px
    }

    .merchant-dashboard-alert.merchant-dashboard-alert-with-icon .alert-icon {
        position: absolute;
        top: 21px;
        left: 20px;
        max-width: 17px
    ...
    .merchant-dashboard-alert.merchant-dashboard-alert-with-icon .alert-icon svg {
        width: 100%;
        height: auto
    }

    .merchant-dashboard-alert.merchant-dashboard-alert-with-upsell-link {
        padding-right: 160px
    }

    .merchant-dashboard-alert.merchant-dashboard-alert-with-upsell-link .merchant-dashboard-external-link {
        position: absolute;
        top: 22px;
        right: 20px
    }

    .merchant-dashboard-external-link {
    ...
    .merchant-dashboard-external-link svg {
        position: relative;
        top: 1px
    }

    .merchant-dashboard-external-link:hover,.merchant-dashboard-external-link:focus,.merchant-dashboard-external-link:active {
        color: #3858e9;
        opacity: .7
    }
    ...
    .merchant-dashboard-pro-tooltip {
        position: relative
    }

    .merchant-dashboard-pro-tooltip:before {
    ...
    .merchant-dashboard-pro-tooltip:after {
        content: "";
        position: absolute;
        bottom: calc(100% + 3px);
        left: 50%;
    ...
    .merchant-dashboard-pro-tooltip:hover:before,.merchant-dashboard-pro-tooltip:hover:after {
        opacity: 1;
        visibility: visible;
...
<div id="athemes-patcher-options-page">
    <?php if ( ! defined( 'MERCHANT_PRO_VERSION' ) ) : ?>
        <div class="merchant-dashboard-alert merchant-dashboard-alert-warning merchant-dashboard-alert-with-icon merchant-dashboard-alert-with-upsell-link">
            ...
            <p class="bt-text-color-grey"><?php echo esc_html__( 'Please note this feature is available only in Merchant Pro', 'merchant' ); ?></p>
            <a href="https://athemes.com/merchant-upgrade?utm_source=athemes-patcher&utm_medium=link&utm_campaign=Merchant" class="merchant-dashboard-external-link" target="_blank">
                <?php echo esc_html__( 'Upgrade Now', 'merchant' ); ?>
    ...
    <?php endif; ?>
    <?php if ( defined( 'MERCHANT_PRO_VERSION' ) && ! defined( 'ATHEMES_PATCHER_VERSION' ) ) : ?>
        <div class="merchant-dashboard-alert merchant-dashboard-alert-warning merchant-dashboard-alert-with-icon merchant-dashboard-alert-with-upsell-link">
            <div class="alert-icon">
                <svg height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg"><title/><path d="M85.57,446.25H426.43a32,32,0,0,0,28.17-47.17L284.18,82.58c-12.09-22.44-44.27-22.44-56.36,0L57.4,399.08A32,32,0,0,0,85.57,446.25Z" fill="none" stroke="#000" stroke-linecap="rounded" stroke-width="32" stroke-linejoin="round" /><path d="M250.26,195.39l5.74,122,5.73-121.95a5.74,5.74,0,0,0-5.79-6h0A5.74,5.74,0,0,0,250.26,195.39Z" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" /><path d="M256,397.25a20,20,0,1,1,20-20A20,20,0,0,1,256,397.25Z"/></svg>
            </div>
            <p class="bt-text-color-grey"><?php echo esc_html__( 'Please note that to use this feature you need to activate the aThemes Patcher plugin.', 'merchant' ); ?></p>
            <a href="#" class="merchant-dashboard-link merchant-dashboard-link-success merchant-dashboard-module-activation merchant-dashboard-external-link" data-module-id="shop-filters" data-module-activate="true" data-module-after-activation-redirect="<?php echo esc_url( get_admin_url() . 'admin.php?page=merchant-dashboard&module-page=shop-filters&settings-page=filter-presets' ); ?>">
                <?php echo esc_html__( 'Install and Activate aThemes Patcher', 'merchant' ); ?>
            </a>
        </div>
    <?php endif; ?>
    ...
    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card athemes-patcher-card css-1hdyajo css-1otwcjs e19lxcc00">
        <div class="css-10klw3m e19lxcc00">
            <h3 class="athemes-patcher-card-title">Merchant Pro</h3>
            <p class="athemes-patcher-card-desc">The following patches are available for the version <?php echo esc_html( MERCHANT_VERSION ); ?></p>
                ...
                <table class="athemes-patchers-table css-18si9r1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a class="components-button has-lock-icon css-adm54n merchant-dashboard-pro-tooltip" href="https://athemes.com/merchant-upgrade?utm_source=athemes-patcher&utm_medium=link&utm_campaign=Merchant" target="_blank" data-tooltip-message="<?php echo esc_attr__( 'This is only available on Merchant Pro', 'merchant' ); ?>">
                                    Apply
