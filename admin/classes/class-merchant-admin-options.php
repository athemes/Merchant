			...
			if ( ! empty( $settings['type'] ) ) {
				...
				if ( ! empty( $settings['title'] ) ) {
                    ...
                    <div class="merchant-module-page-setting-field-title<?php echo esc_attr( $is_upsell ? ' merchant-module-page-setting-field-title__has-upsell' : '' ); ?>">
                        ...
                        <?php if ( $is_upsell ) : ?>
                            <a href="https://athemes.com/merchant-upgrade?utm_source=plugin_dashboard&utm_medium=merchant_dashboard&utm_campaign=Merchant" class="merchant-module-pro-upsell" target="_blank">
