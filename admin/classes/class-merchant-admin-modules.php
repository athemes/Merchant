				...
				'convert-more' => array(
					...
					'modules' => array(
						...
						'quick-view' => array(
							...
							'desc' => esc_html__( 'Instantly preview product details without leaving the page, enhancing browsing efficiency.', 'merchant' ),
				...
				'build-trust' => array(
					...
					'modules' => array(
						...
						'trust-badges' => array(
							...
							'tutorial_url' => 'https://docs.athemes.com/article/trust-badge/',
							'preview_url' => $product_url,
						),
				...
				'reduce-abandonment' => array(
					...
					'modules' => array(
						...
						'inactive-tab-messsage' => array(
							...
							'desc' => esc_html__( 'Dynamically modifying the browser tab\'s title when the visitor navigates away from your store.', 'merchant' ),
				...
				'improve-experience' => array(
					...
					'modules' => array(
						...
						'auto-external-links' => array(
							...
							'desc' => esc_html__( 'Prevent users from navigating away from online store by opening links in a new browser tab.', 'merchant' ),
				...
				'product-your-store' => array(
					...
					'modules' => array(
						...
						'agree-to-terms-checkbox' => array(
							...
							'desc' => esc_html__( 'Obtain consent before customers start the checkout process.', 'merchant' ),
