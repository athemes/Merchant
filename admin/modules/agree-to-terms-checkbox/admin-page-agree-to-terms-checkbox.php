...
Merchant_Admin_Options::create( array(
	...
	'fields' => array(
		...
		array(
			'id'       => 'text',
			'type'     => 'text',
			'title'    => esc_html__( 'Checkbox text on cart page', 'merchant' ),
		...
		array(
			'id'      => 'warning_text',
			'type'    => 'text',
			'title'   => esc_html__( 'Checkbox warning text on cart page', 'merchant' ),
			'default' => esc_html__( 'You must read and accept the terms and conditions to cart.', 'merchant' ),
			'desc'    => esc_html__( 'The error that will be shown if the user tries to go to cart without accepting your terms and conditions.', 'merchant' ),
		),
